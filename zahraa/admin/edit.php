...
<head>
    ...
    <title>Edit Mading | Admin SMK Negeri 1 Banjar</title>
    <style>
        :root {
            --biru-utama: #2c7da0;
            --biru-muda: #61a5c2;
    ...
    <div class="admin-main">
        <div class="admin-header">
            <div class="header-title">
                <h2>Edit Mading</h2>
                <p>Mengedit mading dengan ID #<?php echo $id; ?></p>
            </div>
        </div>
        ...
        <div class="form-container">
            <div class="form-title">
                <h2>Edit Informasi Mading</h2>
                <p>Perbarui data mading yang sudah ada</p>
            </div>
            ...
            <form action="../process/update.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="penulis" value="<?php echo htmlspecialchars($row['penulis']); ?>" required>
                </div>
                ...
                <div class="current-photo">
                    ...
                    <div class="photo-preview">
                        <img src="../uploads/<?php echo htmlspecialchars($row['foto']); ?>" class="current-image" alt="Foto Mading">
                        <div class="delete-checkbox">
                            <input type="checkbox" name="delete_foto" id="delete_foto" value="1">
                            <label for="delete_foto">Hapus foto ini</label>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="file-info">Format: JPG, PNG, GIF | Maks: 2MB | Kosongkan jika tidak ingin mengganti</div>
